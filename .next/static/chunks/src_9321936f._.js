(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_9321936f._.js", {

"[project]/src/contexts/UserProgressContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "useUserProgress": (()=>useUserProgress)
});
...
"use client";
;
const UserProgressContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
const defaultProgress = {
    completedLessons: [],
    completedQuizzes: [],
    quizScores: {}
};
const LOCAL_STORAGE_KEY = 'chemlearn_user_progress';
const UserProgressProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserProgressProvider.useEffect": ()=>{
    ...
    const completeLesson = (lessonId)=>{
        setProgress((prev)=>({
                ...prev,
                completedLessons: prev.completedLessons.includes(lessonId) ? prev.completedLessons : [
    ...
    const completeQuiz = (quizId, score, totalQuestions)=>{
        setProgress((prev)=>({
                ...prev,
                completedQuizzes: prev.completedQuizzes.includes(quizId) ? prev.completedQuizzes : [
    ...
    const setLastAccessedItem = (lectureId, type, id)=>{
        setProgress((prev)=>({
                ...prev,
                lastAccessedItemId: {
                    lectureId,
    ...
    const getLastAccessedItem = ()=>{
        return progress.lastAccessedItemId;
    };
    const resetProgress = ()=>{
        setProgress(defaultProgress);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UserProgressContext.Provider, {
        value: {
            progress,
            completeLesson,
            completeQuiz,
        ...
        fileName: "[project]/src/contexts/UserProgressContext.tsx",
        lineNumber: 103,
        columnNumber: 5
    }, this);
};
_s(UserProgressProvider, "z+b9m+30Vlj+vYzG6P3K5J1mkLg=");
_c = UserProgressProvider;
const useUserProgress = ()=>{
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(UserProgressContext);
    if (context === undefined) {
        throw new Error('useUserProgress must be used within a UserProgressProvider');
    }
    return context;
};
_s1(useUserProgress, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "UserProgressProvider");
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyDp9x_ICCmRxWuC8Pdjamm0tB9eEmsST5I"),
    authDomain: ("TURBOPACK compile-time value", "chemlearn-a7452.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "chemlearn-a7452"),
    storageBucket: ("TURBOPACK compile-time value", "chemlearn-a7452.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "6955293475981:695529347598:web:72b607e6a9084cbdb7ba5f"),
    appId: ("TURBOPACK compile-time value", "1:695529347598:web:72b607e6a9084cbdb7ba5f")
};
// Initialize Firebase
...
const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$68039fd7$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__p__as__getAuth$3e$__["getAuth"])(app);
...
"[project]/src/lib/services/userService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getUserRole(uid) {
    try {
        ...
        return 'user'; // Return 'user' as a fallback on error
    }
}
async function createUserProfile(uid, email, displayName) {
    ...
    const userProfile = {
        ...
        email,
        role: 'user',
        displayName: displayName || email?.split('@')[0] || 'ChemLearner'
    };
    // Check if user profile already exists (e.g. if using social logins that might pre-create)
    ...
    if (!docSnap.exists()) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(userDocRef, userProfile);
    } else {
        // Optionally update if exists, or just ensure role is set
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/firebase.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/userService.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
        ...
        "AuthProvider.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$68039fd7$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "AuthProvider.useEffect.unsubscribe": async (user)=>{
                    setCurrentUser(user);
                    if (user) {
                        const role = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserRole"])(user.uid); // role is now guaranteed to be 'user' | 'admin'
                        const fullUser = {
                            uid: user.uid,
                            email: user.email,
                            role: role,
...
_s(AuthProvider, "TV6qtiDXEbZ4O/BTPtsscliWZ54=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
"[project]/src/components/layout/AppProviders.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$UserProgressContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/UserProgressContext.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useAuth.tsx [app-client] (ecmascript)"); // New import
"use client";
;
;
;
...
function AppProviders({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
        children: [
            " ",
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$UserProgressContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserProgressProvider"], {
                children: [
                    children,
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$toaster$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Toaster"], {}, void 0, false, {
                        fileName: "[project]/src/components/layout/AppProviders.tsx",
                        lineNumber: 14,
                        columnNumber: 9
                    }, this)
                ]
...
function ThemeProvider({ children, defaultTheme = "light", storageKey = "chemlearn-ui-theme" }) {
    _s();
    const [theme, setThemeInternal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultTheme);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        // Note: System preference detection can be added here if `defaultTheme` is 'system'
        // else if (defaultTheme === 'system' && window.matchMedia("(prefers-color-scheme: dark)").matches) {
...
_s(ThemeProvider, "FwohlgonWnlG13+Ik0glqHi6KMg=");
_c = ThemeProvider;
const useTheme = ()=>{
    _s1();
...
//# sourceMappingURL=src_9321936f._.js.map